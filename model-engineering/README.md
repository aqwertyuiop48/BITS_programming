...
or
```bash
python prepare_data.py --input-csv data/raw/titanic_train.csv --output-csv data/processed/titanic_bakeoff_train_1.csv --target-col target --rename-target-from Survived
```
...
or
```bash
python prepare_data.py --input-csv data/raw/titanic_inference.csv --output-csv data/processed/titanic_inference_input.csv --target-col target --allow-missing-target
```
